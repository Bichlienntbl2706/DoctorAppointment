    ...
    return (
        <div style={{ marginTop: '5rem'}}>
            ...
            <dir className="row">
                ...
                {selectedDate && <h5 className='text-title mb-3'>Selected Date: <span className='text-danger'>{selectedDate && moment(selectedDate).format('LL')}</span> <br/>
                       {selectTime && (
                        <>
                            Time: <span className="text-danger">{selectTime}</span>
                        </>
                        ) } 
                        </h5> }
