...
//                             <h2 className=" align-middle text-start table-avatar">
//                               <a className=" align-middle text-start avatar avatar-sm mr-2">
//                                 <img
//                                   className="align-middle text-start avatar-img rounded-circle"
//                                   src={userImg}
//                                   alt=""
//                                 />
//                               </a>
//                               <a className="align-middle text-start"> {`${doctor.firstName} ${doctor.lastName}`}</a>
//                             </h2>
//                           </td>
//                           <td className="align-middle text-start">{doctor.specialization}</td>
//                           <td className="align-middle text-start">${doctorsEarnings[doctor._id] || 0}</td>
//                         </tr>
//                       ))}
//                     </tbody>
//                   </table>
...
//                               <a
//                                 href="profile.html"
//                                 className=" align-middle text-start avatar avatar-sm me-2"
//                               >
//                                 <img
//                                   className=" align-middle text-start avatar-img rounded-circle"
//                                   src={userImg}
...
//                                 />
//                               </a>
//                               <a className="align-middle text-start" href="profile.html">{`${patient.firstName} ${patient.lastName}`}</a>
//                             </h2>
//                           </td>
//                           <td className="align-middle text-start">{patient.mobile}</td>
//                           <td className="align-middle text-start">{patient.gender}</td>
//                         </tr>
//                       ))}
//                     </tbody>
//                   </table>
...
//                                 />
//                               </a>
//                               <a className="align-middle text-start" href="profile.html">
